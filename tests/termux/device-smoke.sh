...
check "doctor reports user profile" check_json_bool ".userProfile.ok" "$doctor_json"
check "doctor reports home profile" check_json_bool ".homeProfile.ok" "$doctor_json"
